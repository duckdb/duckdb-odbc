...
TEST_CASE("Test General SQLColAttribute (descriptor information for a column)", "[odbc]") {
	...
	for (int i = 1; i <= num_cols; i++) {
		...
		EXECUTE_AND_CHECK("SQLColAttribute", SQLColAttribute, hstmt, i, SQL_DESC_LABEL, nullptr, 0, &col_label_size,
		                  nullptr);
		...
		EXECUTE_AND_CHECK("SQLColAttribute", SQLColAttribute, hstmt, i, SQL_DESC_NAME, nullptr, 0, &col_name_size,
		                  nullptr);
		...
		EXECUTE_AND_CHECK("SQLColAttribute", SQLColAttribute, hstmt, i, SQL_DESC_BASE_COLUMN_NAME, nullptr, 0,
